...
import { Book, Video, Headphones, FileText, Download, ExternalLink } from 'lucide-react';
...
const Resources = () => {
  const resourceTypes = [
    ...
    },
    {
      ...
      description: "Practical templates and assessment tools for personal growth",
      count: 40,
  ...
  const featuredResources = [
    ...
    },
    {
      ...
      type: "Template",
      description: "Interactive assessment to identify your core values and align your life accordingly",
      downloadCount: "4.2K",
      category: "Self-Discovery"
    }
  ];
